...
# Appendix B. Results for different assessmnet units
...
for(rr in unique(RS_results$unit_name)) {
  cptn <- sprintf("\n\n**Figure B%s**.  Variability of $RS_i$ (box and whisker plot) and average RS (solid symbols) based on the decline in bioclimatic suitability for the assessment unit of %s.\n\n", fignr, rr)
  cat(cptn)
