...
plot_data <- tibble(fittedPredictedResponse = mod_degradation_simres$fittedPredictedResponse,
       unit_name = mod_degradation_sat$frame$unit_name,
       scn = mod_degradation_sat$frame$scn)
ggplot(plot_data) +
  geom_boxplot(aes(y=fittedPredictedResponse,
                   group=interaction(scn,unit_name))) +
  facet_wrap(~scn)
