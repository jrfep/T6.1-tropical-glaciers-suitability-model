...
#require(glmmTMB)
#require(lme4)
here::i_am("docs/A1/Kilimanjaro.qmd")
#sessionInfo()
...
rds.file <- here::here(target.dir,"relative-severity-degradation-suitability-all-tropical-glaciers-training-thresholds.rds")
RS_results_t <- readRDS(rds.file) %>%
 filter(unit %in% str_replace(slc_unit," ","-"))
