...
```{r}
#| tbl-cap: "Proportion of models predicting collapse by 2100 for each assessment unit."
...
```
Focusing on the 50 year time frame between 2020 and 2070 we find that ... of the models end in collapse. Uncertainty in mass estimates (mean absolute deviation) do not have a major effect on the estimated year of collapse. Considering each scenarios separately, the proportion of models that predict collapse by 2070 is higher than 50% (threshold for CR) in all cases, except for scenario SSP1-2.6.
