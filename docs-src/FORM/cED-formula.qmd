...
header.style <- "th { font-family: 'Arial'; font-weight: bold; color: white; background-color: rosybrown;}"
...
hcell.style <- "text-align: center; border-width: 1px; border-style: solid; border-color: white; font-size:8px; background-color: rosybrown;"
