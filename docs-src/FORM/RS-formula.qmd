...
The figure @fig-rs-ice-example-kili shows the calculation of $\mathrm{RS}_{ice}^{CT=0}$ using the original formula for a selection of units in the T.G.E of Kilimanjaro. 
